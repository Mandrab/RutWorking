...
**********************************************************************************************************************/
    ...
    it('test chat posting', async function() {
        ...
        // no token
        await request.post('/projects/' + CHIEF.project.name + '/modules/' + CHIEF.project.modules[0] + '/kanban')
        ...
        // no project
        await request.post('/projects/FAKE' + CHIEF.project.name + '/modules/' + CHIEF.project.modules[0] +'/kanban')
            .set({ 'Authorization': chiefToken }).expect(404)

        // no module
        await request.post('/projects/' + CHIEF.project.name + '/modules/FAKE' + CHIEF.project.modules[0] +'/kanban')
            .set({ 'Authorization': chiefToken }).expect(404)
